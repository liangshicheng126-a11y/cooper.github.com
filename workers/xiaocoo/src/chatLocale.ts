// Kept local to the Worker so its build does not depend on the frontend workspace.
export type Language = "zh" | "en" | "ja" | "ko";

export function normalizeChatLanguage(value: unknown, fallback: Language = "zh"): Language {
  return value === "zh" || value === "en" || value === "ja" || value === "ko" ? value : fallback;
}

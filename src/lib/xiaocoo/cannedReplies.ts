...
多媒体内容创作：负责工厂宣传视频的策划、拍摄与剪辑，通过动态视觉语言强化品牌背书，提升用户信任感。`,
  },
  {
    ...
    answer: `我一直学习设计学专业，最初在厦门完成了三年专科阶段的学习，之后赴韩国继续本科深造，并以 GPA 4.5/5.0 的成绩获得继续攻读本校同专业硕士的机会。整个学习过程中，我不断深化专业能力，也积累了跨文化环境下的学习和适应经验。目前已经毕业回国，正在寻找设计相关岗位，希望将所学运用到实际工作中。
韩国阶段在大邱加图立大学（融合设计）；硕士 GPA 4.5/5.0。`,
  },
];

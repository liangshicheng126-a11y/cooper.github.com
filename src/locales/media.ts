...
export const mediaTranslations = {
  zh: {
    ...
    videoTitles: ["恐惧是生物的本能", "色彩重启剪辑", "生命随年月流去"],
  ...
  en: {
    ...
    videoTitles: ["Fear Is a Biological Instinct", "Color Reboot Edit", "Life Flows With the Years"],
  ...
  ja: {
    ...
    videoTitles: ["恐怖は生物の本能", "カラー・リブート — 動画編集", "生命は年月とともに流れていく"],
  ...
  ko: {
    ...
    videoTitles: ["두려움은 생물의 본능", "컬러 리부트 영상 편집", "생명은 세월과 함께 흘러간다"],
